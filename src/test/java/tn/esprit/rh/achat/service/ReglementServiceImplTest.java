...
public class ReglementServiceImplTest {
    ...
    void testAddReglement() {
        Reglement reglement = new Reglement(1L,100, 50, false , new Date() , new Facture());
    ...
    void testRetrieveAllReglements() {
        Reglement reglement1 = new Reglement(1L, 100, 50, false, new Date() , new Facture());
        Reglement reglement2 = new Reglement(2L, 200, 100, false, new Date() , new Facture());
