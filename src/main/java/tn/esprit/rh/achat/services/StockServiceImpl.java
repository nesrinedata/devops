...
public class StockServiceImpl implements IStockService {
	...
	public String retrieveStatusStock() {
		...
		for (Stock stock : stocksEnRouge) {
			finalMessage.append(newLine).append(msgDate).append(newLine)
					.append(": le stock ").append(stock.getLibelleStock()).append(" a une quantité de ")
					.append(stock.getQte()).append(" inférieur à la quantité minimale à ne pas dépasser de ")
